...
Run /ddd-roadmap first — its Goal Alignment step writes docs/product-brief.md — then re-run ddd-auto.
...
- `docs/product-brief.md` (generated by ddd-roadmap Step 2.5) — blocks at Step 4.5 if missing
