...
1. **Plan file exists?** — Search `docs/plans/` for a plan matching this item
...
**Skip this step entirely in Batch (Non-Interactive) Mode** — report the commit SHA and let ddd-auto's operator push.
...
Roadmaps use checkbox format (generated by ddd-roadmap):
