...
Run /ddd-brief to generate the product brief, then re-run ddd-spec.
```
...
**Consumes (required):**
- `docs/product-brief.md` generated by **ddd-brief** — blocks if missing
...
ddd-brief ──────────────────────────────────────┐
                                                 ↓
ddd-roadmap ──→ ddd-spec ──→ ddd-develop ──→ ddd-audit
                                   ↑
                                ddd-auto
```
